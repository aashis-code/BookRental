...
//		RENT new book
	...
	public PaginatedResponse getPaginatedBookTransaction(FilterRequest filterRequest) {
		...
		Page<Map<String, Object>> response = bookTransactionRepo.filterBookTransactionAndPagination(filterRequest.getStartDate(), filterRequest.getEndDate(),Boolean.FALSE, filterRequest.getBookId(), filterRequest.getMemberId(), filterRequest.getRentStatus(), pageable);
